...
public class DskTC3_Button extends InitTest {
private TestRailAndExtentReporter tcLogger;
	...
	public void test1(@Optional String tcTitle) {
		...
		if(p1.verifyLaunch(getWebDriver()))
		{
			...
			tcLogger.log(Status.INFO, "Verifying Button Click option");
			p1.clickMe(tcLogger);		
		}
		else
		{
		...
		tcLogger.log(Status.INFO, "DskTC3_Button Executed Successfully ...");
