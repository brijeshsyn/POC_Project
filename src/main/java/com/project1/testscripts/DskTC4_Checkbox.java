...
public class DskTC4_Checkbox extends InitTest {
private TestRailAndExtentReporter tcLogger;
	...
	public void test1(@Optional String tcTitle) {
		...
		if(p1.verifyLaunch(getWebDriver()))
		{
			...
			tcLogger.log(Status.INFO,"Verify CheckBox Menu option");
		...
		tcLogger.log(Status.INFO, "DskTC4_Checkbox Executed Successfully ...");
