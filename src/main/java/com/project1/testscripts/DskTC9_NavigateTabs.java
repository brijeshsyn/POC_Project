...
public class DskTC9_NavigateTabs extends InitTest {
private TestRailAndExtentReporter tcLogger;
	...
	public void test1(@Optional String tcTitle) {
		...
		if(p1.verifyLaunch(getWebDriver()))
		{
			...
			tcLogger.log(Status.INFO,"Verify Tab Navigations on screen...");
		...
		tcLogger.log(Status.INFO, "DskTC9_NavigateTabs Executed Successfully ...");
