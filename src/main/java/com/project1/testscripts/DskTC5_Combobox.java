...
public class DskTC5_Combobox extends InitTest {
private TestRailAndExtentReporter tcLogger;
	...
	public void test1(@Optional String tcTitle) {
		...
		if(p1.verifyLaunch(getWebDriver()))
		{
			...
			tcLogger.log(Status.INFO,"Verify ComboBox Menu option");
		...
		tcLogger.log(Status.INFO, "DskTC5_Combobox Executed Successfully ...");
