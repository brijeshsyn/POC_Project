...
public class DskTC6_Hyperlink extends InitTest {
private TestRailAndExtentReporter tcLogger;
	...
	public void test1(@Optional String tcTitle) {
		...
		if(p1.verifyLaunch(getWebDriver()))
		{
			...
			tcLogger.log(Status.INFO,"Verify Hyperlink Menu option");
			p1.hyperlink(tcLogger);	
		}
		else
		{
		...
		tcLogger.log(Status.INFO, "DskTC6_Hyperlink Executed Successfully ...");
